...
uint32_t get_LED_color(int response) {
  switch (response) {
    case 0:
      return inner_LED_strip.Color(255, 255, 255); //White
    case 1: 
      return inner_LED_strip.Color(0, 255, 0); //Accomodation - Green
    case 2:
      return inner_LED_strip.Color(0, 0, 255); //Ignore - Blue
    case 3:
      return inner_LED_strip.Color(255, 255, 0); //Disperse - Yellow
    case 4:
      return inner_LED_strip.Color(255, 239, 0); //Arrest - Orange
    case 5:
      return inner_LED_strip.Color(255, 0 , 0); //Violence - Red
  }
}
